"""
    Borrowed from https://github.com/togheppi/pix2pix/tree/master
"""
...
class Generator(torch.nn.Module):
    def __init__(self, input_dim, num_filter, output_dim):
        ...
        self.conv4 = ConvBlock(num_filter * 4, num_filter * 8, batch_norm=False)
        ...
        # self.deconv3 = DeconvBlock(num_filter * 8, num_filter * 8, dropout=True)
        self.deconv4 = DeconvBlock(num_filter * 8, num_filter * 4)
        self.deconv5 = DeconvBlock(num_filter * 4, num_filter * 2)
        self.deconv6 = DeconvBlock(num_filter * 2, num_filter)
        self.deconv7 = DeconvBlock(num_filter, output_dim, batch_norm=False)
